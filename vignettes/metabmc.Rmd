---
title: "Estimating and visualizing posterior distribution of model probability with metabmc"
author: "Yuga Hikida"
date: "`r Sys.Date()`"
output:
...
mixture model can be done using all-in-one function `metabmc`.
...
arguments. In this case, all the model is fit inside `metabmc` function.
